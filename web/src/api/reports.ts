...
export const fetchTotalOrderAmount = (params?: {
  dateFrom?: string;
  dateTo?: string;
  salespersonId?: string;
  status?: string;
...
export const fetchPaymentCollect = (params?: {
  dateFrom?: string;
  dateTo?: string;
}) => axios.get('/reports/payment-collect', { params }) as Promise<any[]>;

export const fetchPaymentRecords = (params?: {
  dateFrom?: string;
  dateTo?: string;
}) => axios.get('/reports/payment-records', { params }) as Promise<any[]>;

export const fetchTotalCollectedAmount = (params?: {
  dateFrom?: string;
  dateTo?: string;
...
export const fetchSalespersonRanking = (params?: {
  dateFrom?: string;
  dateTo?: string;
  limit?: number;
...
export const fetchTargetProgress = (period?: string) =>
  axios.get('/reports/target-progress', {
...
export const fetchTargets = (period?: string) =>
  axios.get('/targets', { params: period ? { period } : undefined }) as Promise<
    any[]
  >;
